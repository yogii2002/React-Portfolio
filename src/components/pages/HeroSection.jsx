...
export default function HeroSection() {
  return (
    <div>
    <div className="main-content flex flex-col sm:flex-row w-full items-center justify-center mx-auto ">
      {/* Left Side: Text and CV Download */}
      <div className="text-section w-full sm:w-[50%]">
        <div className="title text-[4rem] font-semibold">
          Hi there! <br /> I am <br /><HighlightText text={'Yogesh Jat'} />
        </div>
        <div className="description text-wrap w-full sm:w-[35rem] mt-[1rem] mb-[1rem] font-semibold text-gray-300">
