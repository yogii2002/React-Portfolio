...
export default function Contact() {
  return (
    <div id='contact' className='flex flex-col items-center justify-center bg-slate-900 w-[100%]  m-4 gap-3'>
        <div className='flex justify-evenly w-[100%]'>
        {/* left */}
            <div className='flex w-[60%] flex-col gap-[2rem] mt-1'>
                ...
                <div className=' text-gray-300 text-[1rem] font-semibold'>
                    ...
                    <p>
                        ...
                        <br />
                        A strong passion for technology and problem-solving, I also enjoy cricket and walking in my leisure time.</p>
                </div>
            ...
            {/* right */}
            <div className='rounded-[100%] h-[20rem] w-[20rem] border-[3px] border-[#22d9f9] overflow-hidden flex justify-center items-start object-cover'><img src={myimage} alt="Yogesh Jat" className=''/></div>
        </div>
