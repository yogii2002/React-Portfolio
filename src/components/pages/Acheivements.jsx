...
export default function Acheivements() {
  ...
  <div className='grid grid-cols-1 sm:grid-cols-2 mx-auto w-[90%] md:w-[80%] gap-[3rem] mt-[8rem] mb-[2rem]'>
    <AcheivementCard title={"Leetcode"} profilelink={"https://leetcode.com/u/yogii2002/"} />
    <AcheivementCard title={"GeeksforGeeks"} profilelink={"https://www.geeksforgeeks.org/user/yogeshjat02/"} />
  </div>
</div>
