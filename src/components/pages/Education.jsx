...
export default function Education() {
  ...
  <div className={`flex flex-col sm:flex-row items-center justify-center gap-[2rem] transform transition-transform duration-[3000ms] ease-out ${isEduVisibleInPort ? "translate-x-0 opacity-100" : "-translate-x-[50%] opacity-0"}`} ref={educationRef}>
    ...
    <div className='flex flex-col gap-y-[4rem]'>
      <div className='flex gap-x-[1rem] rounded-2xl items-center hover:bg-gradient-to-tl from-gray-800 to-slate-700 p-4'>
        ...
        <div>
          <h2 className='text-[2rem] font-bold bg-gradient-to-tl from-[#b9e7f0] via-[#5db1c4] to-[#0fbed1] bg-transparent bg-clip-text text-transparent'>
      ...
      <div className='flex gap-x-[1rem] items-center rounded-2xl hover:bg-gradient-to-tl from-gray-800 to-slate-700 p-4'>
        ...
        <div>
          <h2 className='text-[2rem] font-bold bg-gradient-to-tl from-[#b9e7f0] via-[#5db1c4] to-[#089bbc] bg-transparent bg-clip-text text-transparent'>
